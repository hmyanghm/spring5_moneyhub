...
brd_vue = {
	...
	brd_write: x =>{
		...
		'<form id="write_form">'+
		'<input type="text" id="writer" name="writer" style="margin-top:20px" class="form-control" placeholder="작성자 ID" />'+
		'<input type="text" id="title" name="title" style="margin-top:20px" class="form-control" placeholder="제목" /><br />'+
		'<div class="row">'+
