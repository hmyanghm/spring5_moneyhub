...
auth_vue = {
	...
	join_body : ()=>{
        ...
        '            <input type="text" class="form-control" id="clientid" placeholder="ID" value="" required="">'+
	...
	login_body : x=>{
		...
		'	  <input type="text" id="clientid" class="form-control" placeholder="ID" required="" autofocus="">'+
